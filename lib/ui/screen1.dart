    ...
    return Scaffold(
                      ...
                      child: Container(
                        decoration: BoxDecoration(
                            gradient: LinearGradient(
                              ...
                              colors: [
                                Color.fromARGB(255, 47, 38, 217)
                                    .withOpacity(0.90),
                                Color.fromARGB(178, 228, 22, 74)
                                    .withOpacity(0.90),
                                Color.fromARGB(255, 151, 47, 199)
                                    .withOpacity(0.90),
                              ],
                              stops: const [
                                0.10,
                              ...
                              transform: const GradientRotation(0.4 *
                                  3.14), // Rotate the gradient by 90 degrees (0.5 * pi)
                            ),
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          // getData();
          Navigator.push(
              context, MaterialPageRoute(builder: (context) => PriceGraph()));
          setState(() {});
        },
